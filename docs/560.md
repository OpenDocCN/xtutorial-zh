...
> 原文:[https://wpf-tutorial . com/misc-controls/the-calendar-control/](https://wpf-tutorial.com/misc-controls/the-calendar-control/)
...
![](../Images/07f3ecfd80b20174e24e0c51e19c7654.png "Simple Calendar control")

请注意，您现在如何获得所选月份内日期的完整列表，包括使用控件顶部的箭头跳转到上个月和下个月的可能性。除非您设置了特定日期，否则将显示当前月份，并且当前日期将被标记为选中。
...
![](../Images/c40907817389c68b5e8dacccf96ef30c.png "Calendar ViewBox Uniform")
...
![](../Images/8c140699ef8f4e3ff80c63f292450361.png "Calendar ViewBox fill")
...
![](../Images/97f7cf37a61329fb1c69ba63dbe4ec45.png "Calendar control with DisplayDate")
...
![](../Images/3846671fd27c008e63e7a28e4bb86b85.png "Calendar SelectionMode")
...
![](../Images/c516f9a38bec792f18f6ce74cf6889d3.png "Calendar with MultipleRange SelectionMode")
...
![](../Images/7868df8c2c0e2a29f8e6a55ea05843a4.png "Calendar using the SelectedDate property")
...
![](../Images/4771168b13ff0bb78604d6eabb406260.png "Calendar Date validation")
...
![](../Images/f97d7e09010a7ba305a3bdfc2f4ca158.png "Multiple dates selected for the Calendar control")
...
根据使用 Calendar 控件的目的，您可能希望屏蔽某些日期。这可能是相关的，例如在预订应用程序中，您想要防止已经预订的日期被选择。日历控件通过使用 **BlackoutDates** 集合支持这种开箱即用的功能，当然，您可以从 XAML 和代码隐藏中使用该集合:
...
![](../Images/c78d375ea117fa23b8e90c87ab4510d7.png "Calendar with blacked out dates using the BlackoutDates property")
...
![](../Images/aff4c342eee42120a44736e07f174a83.png "Calendar with DisplayMode set to Year")
...
![](../Images/86d23d04c4a25578346efee08c7ac12d.png "Calendar with DisplayMode set to Decade")

## 摘要

如您所见，Calendar 控件是一个非常通用的控件，有很多选项和功能，只需要很少的配置就可以使用。如果您正在构建一个具有任何日期相关功能的应用程序，您可能会以某种方式使用日历控件。
